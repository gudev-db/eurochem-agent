...
with tab_chatbot:  
    ...
    if prompt := st.chat_input("Como posso ajudar?"):
        ...
        Baseie todas as suas respostas nestas diretrizes oficiais da Eurochem
        {conteudo}
            ...
            if not texto_original.strip():
                ...
                with st.spinner("Processando resumo..."):
                    try:
                        ...
                        prompt = f"""
                        Crie um resumo profissional deste texto para a Eurochem Cooperativa Agroindustrial,
